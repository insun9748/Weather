  ...
  sites: {
    ocean: {
      ...
      quiz: {
        ...
        options: [
          { label: '2020년 해수면 온도가 평년보다 높았다.', outcome: 'correct' },
          { label: '2020년 해수면 온도가 평년보다 낮았다.', outcome: 'wrong' },
        ],
      },
      correct: { background: oceanCorrectBg },
      quiz2: {
        background: oceanQuiz2Bg,
        options: [
          { label: '증발이 활발해주고 남서풍을 타고 많은 수증기가 한반도로 이동한다.', outcome: 'correct' },
          { label: '바닷물이 차가워져 수증기가 감소한다.', outcome: 'wrong2a' },
          { label: '수증기가 바로 비가 되어 바다에서 모두 내린다.', outcome: 'wrong2b' },
        ],
      },
      correct2: { background: oceanCorrect2Bg },
      wrong: { background: oceanWrongBg },
      wrong2a: { background: oceanWrong2aBg },
      wrong2b: { background: oceanWrong2bBg },
      hint: { background: oceanHintBg, frontImage: oceanHintFront, backImage: oceanHintBack },
      notebook: { background: oceanNotebookBg },
    },
    ...
    satellite: {
      ...
      quiz: {
        ...
        options: [
          { label: '장마전선이 빠르게 북상했다.', outcome: 'wrong1' },
          { label: '장마전선이 한반도 부근에 오랫동안 정체했다.', outcome: 'correct' },
          { label: '장마전선이 사라졌다.', outcome: 'wrong2' },
        ],
      },
      zoom: { background: satelliteZoomBg },
      wrong1: { background: satelliteWrong1Bg },
      wrong2: { background: satelliteWrong2Bg },
      correct: { background: satelliteCorrectBg },
      hint: { background: satelliteHintBg, frontImage: satelliteHintFront, backImage: satelliteHintBack },
      notebook: { background: satelliteNotebookBg },
    },
  },
